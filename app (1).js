...
const neuronSequence = {
  title: "How does a neuron “decide” whether to fire an action potential?",
  introSlides: [
    {
      type: "intro",
...
const populationCodingSequence = {
  title: "Why does the brain use many neurons at once instead of a single “detector” neuron for each stimulus?",
  introSlides: [
    {
      type: "intro",
...
const inhibitionSequence = {
  title: "Why is inhibition essential in the brain if we “want to send signals”?",
  introSlides: [
    {
      type: "intro",
...
const emergentRhythmsSequence = {
  title: "How can simple local rules in neurons and synapses generate global activity patterns in a network?",
  introSlides: [
    {
      type: "intro",
...
const contrastNormalizationSequence = {
  title: "How does the brain solve the problem of “same stimulus, different background”?",
  introSlides: [
    {
      type: "intro",
...
const changeDetectionSequence = {
  title: "Why does the brain care more about differences and changes than about absolute values?",
  introSlides: [
    {
      type: "intro",
...
const multiplexedCodingSequence = {
  title: "How can a single pathway carry information about “what,” “where,” and “how strong” at the same time?",
  introSlides: [
    {
      type: "intro",
...
const efferenceCopySequence = {
  title: "Why does the brain need an internal copy of its own motor commands?",
  introSlides: [
    {
      type: "intro",
...
const associativeMemorySequence = {
  title: "How can a neural network “fill in the blanks” and reconstruct a whole pattern from a partial cue?",
  introSlides: [
    {
      type: "intro",
...
const balancedPlasticitySequence = {
  title: "Why must synaptic plasticity go both “up” and “down” for the brain to remain stable and still learn?",
  introSlides: [
    {
      type: "intro",
